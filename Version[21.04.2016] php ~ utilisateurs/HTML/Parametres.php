            ...
            <form method="POST" action="" enctype="multipart/form-data">            
                <table id="parametres_table">
                    <tr id="parametres_tr">
                        ...
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_prenom" class="modif"><input id="prenom" placeholder="Prénom" name="new_prenom" class="0" onBlur="verif_prenom(prenom)" ><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>
                    <tr id="parametres_tr">
                        <td>Nom</td>
                        <td><?php echo $user['nom'];?></td>
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_nom" class="modif"><input id="nom" placeholder="Nom" name="new_nom" class="0" onBlur="verif_prenom(prenom)" ><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>
                    <tr id="parametres_tr">
                        <td>Login</td>
                        <td><?php echo $user['login'];?></td>
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_login" class="modif"><input id="login" placeholder="Login" name="new_login" onBlur="verif_login(login)"><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>
                    <tr id="parametres_tr">
                        <td>Date de naissance</td>
                        <td><?php echo $user['date_naissance'];?></td>
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_date" class="modif"><input id="date" type="date" name="new_date" value="" onBlur=""><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>
                    <tr id="parametres_tr">
                        <td>Adresse e-mail</td>
                        <td><?php echo $user['mail'];?></td>
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_mail" class="modif"><input type="email" id="mail" placeholder="Adresse e-mail" name="new_mail" onBlur="verif_mail(mail)"><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>
                    <tr id="parametres_tr">
                        <td>Mot de passe</td>
                        <td></td>
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_mdp" class="modif"><input type="password" id="mdp" placeholder="Mot de passe" name="new_mdp1" value="" onBlur="verif_mdp(mdp)"><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>
                    <tr id="parametres_tr">
                        <td>Photo de profil</td>
                        <td></td>
                        <td><a href="#"><img src="../images/modifier.png" id="modifier_ico" class="img" /></a></td>
                        <td><div id="modif_mdp" class="modif"><input type="file" name="avatar" value=""><!--<a href=""><img src="../images/save.png" class="save" id="save_ico"/></a>--></div></td>
                    </tr>  
                    </table>
